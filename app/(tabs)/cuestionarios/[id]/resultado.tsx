...
export default function ResultadoCuestionario() {
    ...
    // Datos temporales
    // Más adelante vendrán del cálculo real del cuestionario
    const resultado = {
        porcentaje: 72,

        nivel:
            "Nivel de bienestar: Balanceado",

        descripcion:
            "Tus respuestas reflejan recursos personales favorables para afrontar distintas situaciones. Continúa fortaleciendo tus estrategias de autocuidado.",
        ...
        indicadores: [
            {
                ...
                porcentaje: 85,
                descripcion:
                    "Capacidad para identificar pensamientos y tomar decisiones conscientes.",
                icono:
...

            {
                ...
                porcentaje: 62,
                descripcion:
                    "Percepción de vitalidad y motivación intrínseca.",
                icono:
...

            {
                ...
                porcentaje: 48,
                descripcion:
                    "Regulación de impulsos y reconocimiento de emociones.",
                icono:
...

            {
                ...
                porcentaje: 92,
                descripcion:
                    "Percepción del descanso y recuperación física.",
                icono:
    ...
    return (
        <View className="flex-1 bg-slate-50">
            ...
            >
                ...
                >
                    Hemos analizado tus respuestas. Estos datos son una guía para apoyar
                    tu proceso de autoconocimiento.
                </Text>
                ...
                <View className="bg-blue-500 rounded-3xl p-5 mb-6">
                    ...
                    >
                        Descarga un informe detallado para conservarlo o compartirlo con un
                ...
                <View className="bg-blue-100 rounded-3xl p-5 mt-6 flex-row items-start">
                    ...
                    <View className="flex-1 ml-3">
                        ...
                        >
                            Esta autoevaluación tiene fines orientativos y educativos. Sus
                            resultados no constituyen un diagnóstico médico o psicológico y
                            no sustituyen la valoración de un profesional.
                        </Text>
                    </View>
                </View>
            </ScrollView>
